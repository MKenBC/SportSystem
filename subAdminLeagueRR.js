...
const syFrom = localStorage.getItem("subEventSYFrom");
const syTo = localStorage.getItem("subEventSYTo");
const eName = localStorage.getItem("subEventName");
const gName = localStorage.getItem("subGameName");
const gDate = localStorage.getItem("subPassDate");
...
async function SaveTeamScore() {
  ...
  if (winTeamScore.value != "" && lossTeamScore.value != "") {
    if (parseInt(winTeamScore.value) > parseInt(lossTeamScore.value)) {
      ...
      swal(
        "Oww!",
        "*Winning Team Score should be Bigger than Non-winning Team Score",
        "error"
      );
